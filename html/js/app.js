$(function () {
    ...
    NECharacter.UpdateModalData = function () {
        ...
        if (!canContinue) {
            toastr.error('Debes completar todos los campos.', 'Whoops!')
        } else {
